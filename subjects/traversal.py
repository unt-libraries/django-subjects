...
class TraversalUtils:
    ...
    # Functionality: Creates a list of parent objects of the browse_subject(child) object.
    # The list is comprised of every parent's parent from the browse_subject node(child)
    # to the root node.
